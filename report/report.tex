...
Prepared traces for executables (same as ones used in Part 1). \\
Used pin to generate traces: \\
\texttt{pin -t obj-intel64/champsim\_tracer.so -o <program>.trace -t 20000000 -- <executable>;} \\
...
\begin{table}[H]
    \begin{tabular}{||l||l|c||c||}
        ...
        \hline
        \texttt{bfs.o}              & \texttt{N\_NODES (1<<20)}; \texttt{N\_LOOPS 500} & 5.2 s          & 2368 KB    \\
        \hline
        \texttt{matrix\_multi.o}    & \texttt{N\_DIMS 1400};                           & 6.8 s          & 7264 KB    \\
        \hline
        \texttt{matrix\_multi\_2.o} & \texttt{N\_DIMS 1400};                           & 4.5 s          & 7264 KB    \\
        \hline
        \texttt{quicksort.o}        & \texttt{N\_ELEM (3 << 13)};                      & 4.1 s          & 9776 KB    \\
        \hline
    \end{tabular}
\end{table}
